...
class Dataset extends Requestable {
   ...
   /**
    * Retrieving Dataset contents
    * @param {object} options Amount to retrieving
    * @param datasetId To update dataset's Id
    * @param {Requestable.callback} [cb] - will receive the API response
    * @return {Promise} - the promise for the http request
    */
   getDatasetContent(options, datasetId, cb) {
      return this._request('GET', `/datasets/${datasetId}/contents`, options, cb);
   }

   /**
    * Update Dataset contents
    * @param {object} options Contents data
    * @param datasetId To update dataset's Id
    * @param {Requestable.callback} [cb] - will receive the API response
    * @return {Promise} - the promise for the http request
    */
   updateDatasetContent(options, datasetId, cb) {
      return this._request('PUT', `/datasets/${datasetId}/contents`, options, cb);
   }
